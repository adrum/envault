...
export default function AppLogoIcon(props: SVGAttributes<SVGElement>) {
  return (
    <svg
      ...
      {...props}
      viewBox="0 0 2220 2320"
      preserveAspectRatio="xMidYMid meet"
    >
      <style>
        {/* Handle dark mode */}
        {`
            svg#app-logo-icon:is([data-mantine-color-scheme="dark"] *) {
                path, polygon {
                    fill: #FFF;
                }
            }
