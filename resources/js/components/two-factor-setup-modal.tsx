...
function TwoFactorSetupStep({
  ...
  const clipboardIcon = clipboard.copied ? faCheck : faClipboard;
            ...
            <div className="flex w-full items-stretch overflow-hidden rounded-xl border border-border">
              {!manualSetupKey ? (
                ...
                <>
                  ...
                  >
                    <FontAwesomeIcon icon={clipboardIcon} className="w-4" />
                  </button>
                </>
              )}
            </div>
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        <div>
          <div className="flex w-full flex-col items-center gap-2 text-lg font-bold">
            ...
            <div className="text-lg font-bold">{modalConfig.title}</div>
          </div>
        </div>
